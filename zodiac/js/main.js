...
var AstroSign;
  ...
  if ((whichMonth == 12 && whichDayOfMonth >= 22) || (whichMonth == 1 && whichDayOfMonth <= 19)) {
    AstroSign = "treebeard";
    displayZodSign('click', AstroSign);
...
function playAudio (whichSound) {
  ...
  document.getElementById('aragornAudio').pause();
  //document.getElementById('aragornAudio').currentTime = 0.0;

  document.getElementById('faramirAudio').currentTime = 0;
  document.getElementById('faramirAudio').pause();
